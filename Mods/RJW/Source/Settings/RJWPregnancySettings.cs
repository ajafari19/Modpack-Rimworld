...
namespace rjw
{
	public class RJWPregnancySettings : ModSettings
	{
		...
		{
			base.ExposeData();
			Scribe_Values.Look(ref humanlike_pregnancy_enabled, "humanlike_pregnancy_enabled", true, true);
			Scribe_Values.Look(ref animal_pregnancy_enabled, "animal_enabled", true, true);
			Scribe_Values.Look(ref bestial_pregnancy_enabled, "bestial_pregnancy_enabled", true, true);
			Scribe_Values.Look(ref insect_pregnancy_enabled, "insect_pregnancy_enabled", true, true);
			Scribe_Values.Look(ref egg_pregnancy_implant_anyone, "egg_pregnancy_implant_anyone", true, true);
			Scribe_Values.Look(ref egg_pregnancy_fertilize_anyone, "egg_pregnancy_fertilize_anyone", false, true);
			Scribe_Values.Look(ref mechanoid_pregnancy_enabled, "mechanoid_enabled", true, true);
			Scribe_Values.Look(ref trait_filtering_enabled, "trait_filtering_enabled", true, true);
			Scribe_Values.Look(ref use_parent_method, "use_parent_method", true, true);
			Scribe_Values.Look(ref humanlike_DNA_from_mother, "humanlike_DNA_from_mother", 0.5f, true);
			Scribe_Values.Look(ref bestial_DNA_from_mother, "bestial_DNA_from_mother", 1.0f, true);
			Scribe_Values.Look(ref bestiality_DNA_inheritance, "bestiality_DNA_inheritance", 0.5f, true);
			Scribe_Values.Look(ref humanlike_impregnation_chance, "humanlike_impregnation_chance", 25, true);
			Scribe_Values.Look(ref animal_impregnation_chance, "animal_impregnation_chance", 25, true);
			Scribe_Values.Look(ref interspecies_impregnation_modifier, "interspecies_impregnation_chance", 0.2f, true);
			Scribe_Values.Look(ref complex_interspecies, "complex_interspecies", true, true);
			Scribe_Values.Look(ref fertility_endage_male, "RJW_fertility_endAge_male", 1.2f, true);
			Scribe_Values.Look(ref fertility_endage_female_humanlike, "fertility_endage_female_humanlike", 0.58f, true);
			Scribe_Values.Look(ref fertility_endage_female_animal, "fertility_endage_female_animal", 0.96f, true);
		}
	}
}