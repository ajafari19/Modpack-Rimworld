...
{
	/// <summary>
	/// No idea what this is, dosnt look to be used anywhere
	/// </summary>
	public class ThinkNode_ConditionalTrait : ThinkNode_Conditional
	{
		...
		protected override bool Satisfied(Pawn pawn)
		{
			if (trait == null)
				if (pawn.story != null)
				{
					//--Log.Message(xxx.get_pawnname(pawn)+" has trait" + this.trait.defName + ":" + pawn.story.traits.HasTrait(this.trait));
